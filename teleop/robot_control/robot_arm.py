...
class H1ArmController:
    def __init__(self):
        ...
        self.kp_low = 60.0 # original value:140.0
        self.kd_low = 1.5 # original value:7.5
    ...
    def __pack_crc(self):
        ...
        '''
        origData = []
        # usr ljt anno: original code for H1-2
        #origData.append(self.msg.mode_pr)
        #origData.append(self.msg.mode_machine)
        origData.extend(self.msg.head)  # usr ljt add for h1
        ...
        origData.append(self.msg.reserve)   # usr ljt add for h1
        origData.append(self.msg.crc)
        '''
    ...
    def LowCommandWriter(self):
        while True:
            # usr ljt add
            #print(f"This is LowCommandWriter")
